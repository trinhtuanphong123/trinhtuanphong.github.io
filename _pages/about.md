...
* **Dự báo năng lượng (Energy Forecasting):** Xây dựng hệ thống MLOps để dự báo tiêu thụ điện và cường độ carbon.
* **Phân tích dữ liệu Airbnb:** Mô hình hỗ trợ quyết định dự đoán giá thuê dựa trên dữ liệu thực tế.
* **Mã hóa & Thuật toán:** Tìm hiểu về độ phức tạp thuật toán và tấn công hệ mật ElGamal.
...
* **Đại học Bách khoa Hà Nội (HUST)**
  * *Sinh viên năm 4 - Ngành Toán Tin (Chuyên ngành Dữ liệu)*
  * 2022 - Hiện tại
...
---
*Nếu bạn muốn trao đổi về chuyên môn hoặc các dự án tiềm năng, hãy kết nối với tôi qua các kênh ở cột bên trái.*
